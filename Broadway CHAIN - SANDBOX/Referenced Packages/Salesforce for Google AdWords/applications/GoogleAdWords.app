...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <tab>Client_Alerts__c</tab>
    <tab>First_Contact_Form</tab>
    <tab>MultiEntry_Timeline_Event</tab>
    <tab>Performance__c</tab>
    <tab>Project_Visits__c</tab>
    <tab>Support_Needs_Lifestyle__c</tab>
    <tab>Session__c</tab>
    <tab>Session_attendance__c</tab>
